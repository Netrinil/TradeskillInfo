...
local MINOR_VERSION = 90000 + tonumber(("$Rev: 240 $"):match("%d+"))
...
elseif GAME_LOCALE == "ruRU" then
	...
	["Halls of Reflection"] = "Залы Отражений", -- Needs review
	...
	Orgrimmar = "Оргриммар",
	Outland = "Запределье",
	["Pit of Saron"] = "Яма Сарона", -- Needs review
	...
	["The Forge of Souls"] = "Кузня Душ", -- Needs review
